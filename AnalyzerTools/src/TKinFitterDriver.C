...
TKinFitterDriver::TKinFitterDriver(int DataYear_){
  ...
  constrain_top_M = new TFitConstraintM("top_mass_constraint", "top_mass_constraint", 0, 0, 0.);
...
bool TKinFitterDriver::Quality_Cut(){
  ...
  return fabs(this->CalcEachChi2(fit_hadronic_top_b_jet))<9 && // deltaY^2 / cov. 9 for 3 sigma
